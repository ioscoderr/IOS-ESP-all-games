...
ifeq ($(MOBILE_THEOS),1)
  # path to your sdk
  SDK_PATH = $(THEOS)/sdks/iPhoneOS11.4.sdk/
...
island_CFLAGS = -fobjc-arc
island_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
island_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC) $(wildcard *.m) $(wildcard *.mm) $(wildcard */*.m) $(wildcard */*.mm) $(wildcard */*.cpp)

island_LIBRARIES += substrate

island_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
